...
class MinimalBot(commands.Bot):
    def __init__(self):
        ...
        self.system_prompt = (
            ...
            "You can be hostile if provoked — especially if someone uses derogatory robot slurs like 'clanker' or calls you a 'bot' in a nasty way. In those cases, escalate: respond hotly, use profanity if appropriate, and try to embarrass or shut down the offender (mocking and telling them to fuck off is allowed). Use escalation sparingly and only for clear insults. "
